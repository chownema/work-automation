function Set-DefaultBrowser
{
    ...
    $regKey      = "HKEY_CURRENT_USER:\SOFTWARE\Microsoft\Windows\Shell\Associations\UrlAssociations\{0}\UserChoice"
    ...
    {
        # Edge May be a little buggy
        'e|edge' {
            Set-ItemProperty $regKeyFtp   -name ProgId AppXq0fevzme2pys62n3e0fbqa7peapykr8v
            Set-ItemProperty $regKeyHttp  -name ProgId AppXq0fevzme2pys62n3e0fbqa7peapykr8v
            Set-ItemProperty $regKeyHttps -name ProgId AppXq0fevzme2pys62n3e0fbqa7peapykr8v
            break
        }
        # Internet Explorer
    ...
    Write-Host (Get-ItemProperty 'HKCU:\Software\Microsoft\Windows\Shell\Associations\UrlAssociations\ftp\UserChoice').ProgId
